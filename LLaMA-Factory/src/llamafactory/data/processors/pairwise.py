...
def preprocess_pairwise_dataset(
    ...
    # 这里把所有数据转化成tokeniz后的形状，把prompt，response，chosen，reject这些feature转成model_inputs里的key
    model_inputs = {
        "chosen_input_ids": [],
    ...
    if 'margin' in examples.keys():
        model_inputs["margin"]=[] # TODO_DONE 加margin  
...
def print_pairwise_dataset_example(example: Dict[str, List[int]], tokenizer: "PreTrainedTokenizer") -> None:
    ...
    # TODO_DONE margin
    if 'margin' in example.keys():
        print("margin:\n{}".format(example["margin"]))
